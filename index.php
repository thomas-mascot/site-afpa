	...
	<nav class="col-md-12 navbar navbar-expand-lg navbar-dark">
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    	<ul class="navbar-nav mr-auto">
      		...
      		<li class="nav-item active">
       			 <a class="nav-link" href="article-femme.php">Femme</a>
      		</li>
      		<li class="nav-item active">
        		<a class="nav-link" href="article-homme.php">Homme</a>        
     		</li>
     		<li class="nav-item active">
             <?php
...
<div class="container-fluid mt-3 mb-0">
    ...
    <div class="container">     
      <div class="row mt-3">
        <div class="col-3">
          <div class="card">
              <img class="card-img-top" src="image/F1.jpg" alt="Card image cap">
            <div class="card-body">
        ...
        <div class="col-3">
          <div class="card">
              <img class="card-img-top" src="image/F4.jpg" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Card title</h5>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              <a href="#" class="btn btn-primary">Fiche produit</a>
        ...
        <div class="col-3">
          <div class="card">
              <img class="card-img-top" src="image/h8.jpg" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Card title</h5>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              <a href="#" class="btn btn-primary">Fiche produit</a>
